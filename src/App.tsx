...
export default function App(){const[project,setProject]=useState<Project|null>(null);return <><a className="skip-link" href="#main">Skip to content</a><Navigation/><main id="main"><Hero/><Identity/><Work onProject={setProject}/><Experience/><Intersection/><Capabilities/><Publications/><Contact/></main><CaseStudy project={project} onClose={()=>setProject(null)}/></>;}
